        ...
        <div className="items-center lg:flex">
          <div className="w-full lg:w-1/2">
            <div className="lg:max-w-lg">
              ...
              <Link to="/allPlace">
                <button className="w-full tracking-wider px-6 py-2.5 mt-6 text-sm text-white  duration-300 transform bg-emerald-500 rounded-md lg:w-auto hover:bg-emerald-500 focus:outline-none focus:bg-emerald-500 hover:px-14">
                  Book Now
                </button>
              </Link>
              <Link to="/login">
