...
const Login = () => {
  ...
  const { logIn, googleSignIn, githubSignIn, user, loading } =
  ...
  return (
    ...
    focus:text-black focus:bg-white focus:border-blue-600 focus:outline-none"
            ...
            <button
              type="submit"
              className="w-full tracking-wider px-8 py-2.5 text-sm text-emerald-400  duration-300 transform border border-teal-500 hover:text-white rounded-md lg:w-auto hover:bg-emerald-500 focus:outline-none focus:bg-emerald-500 hover:px-14"
            >
              Log in
            </button>
          </form>
